...
namespace pesieve {
	...
	public:
		...
		bool dumpJsonReport(ProcessScanReport &process_report, const t_report_filter &filter, const pesieve::t_json_level &jdetails);

		bool dumpJsonReport(ProcessDumpReport &process_report);

		bool dumpJsonReport(ErrorReport& error_report, const t_report_filter& filter);
