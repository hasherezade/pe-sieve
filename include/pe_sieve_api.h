...
PEsieve_report PESIEVE_API_FUNC PESieve_scan_ex(const PEsieve_params args, const PEsieve_rtype rtype, char* json_buf, size_t json_buf_size, size_t *buf_needed_size);
