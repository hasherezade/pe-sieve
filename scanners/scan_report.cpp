...
bool pesieve::ProcessScanReport::hasAnyShownType(const pesieve::t_report_filter &filter)
{
...
std::string pesieve::ProcessScanReport::listModules(size_t level, const pesieve::t_report_filter &filter, const t_json_level &jdetails) const
{
...
const bool pesieve::ProcessScanReport::toJSON(
	...
	const pesieve::t_report_filter &filter, 
